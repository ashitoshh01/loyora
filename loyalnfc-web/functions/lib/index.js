...
exports.getPublicBusinessProfile = exports.getBusinessDashboardOverview = exports.recordVisit = exports.computeLoyaltyStatus = exports.resolveCardToken = exports.replaceCard = exports.blockCard = exports.assignCardToCustomer = exports.generateCardToken = exports.updateBusinessStatus = exports.createBusiness = exports.setUserRole = void 0;
 ...
 */
exports.getBusinessDashboardOverview = (0, https_1.onCall)(async (request) => {
    const data = request.data || {};
    const businessId = getCallerBusinessId(request, data.businessId);
    const bizSnap = await db.collection("businesses").doc(businessId).get();
    if (!bizSnap.exists) {
        throw new https_1.HttpsError("not-found", "Business record not found.");
    }
    const bizData = bizSnap.data() || {};
    const timezone = bizData.timezone || "Asia/Kolkata";
    const now = new Date();
    ...
    const [totalCustomersSnap, activeMembersSnap, visitsTodaySnap, visitsMonthSnap, activeCardsSnap, blockedCardsSnap, expiringMembershipsSnap,] = await Promise.all([
 ...
 */
exports.getPublicBusinessProfile = (0, https_1.onCall)(async (request) => {
    const slug = request.data?.businessSlug;
    if (!slug || typeof slug !== "string") {
        throw new https_1.HttpsError("invalid-argument", "businessSlug is required.");
    }
    ...
    const bizSnap = await db
        ...
        .limit(1)
        .get();
    let bizDoc = !bizSnap.empty ? bizSnap.docs[0] : null;
    ...
    if (!bizDoc) {
        throw new https_1.HttpsError("not-found", "Business profile not found.");
    }
